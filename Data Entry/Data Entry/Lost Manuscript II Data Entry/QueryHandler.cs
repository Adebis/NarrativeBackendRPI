            ...
            if (split_input[0].ToLower().Equals("chronology"))
            {
                ...
                if (graph.file_name.Equals("roman_ww2_analogy.xml") || graph.file_name.Equals("roman_ww2_analogy_2.xml"))
                {
                    ...
                    if (story_features.Count > 0)
                    {
                        ...
                        string analogy_text = "Remember the Battle of Actium? Well, it's like the Mediterranean and Middle East theatre. This is because the Ptolemaic Kingdom fought in the Battle of Actium, the same way that World War II took place in the Mediterranean and Middle East theatre. And, like how Marcus Vipsanius Agrippa was a commander in the Battle of Actium, Benito Mussolini was a commander in the Mediterranean and Middle East theatre.";
