            ...
            if (split_input[0].ToLower().Equals("chronology"))
            {
                ...
                if (graph.file_name.Equals("roman_ww2_analogy.xml") || graph.file_name.Equals("roman_ww2_analogy_2.xml"))
                {
                    ...
                    if (story_features.Count > 0)
                    {
                        ...
                        string analogy_text = "Remember the Battle of Actium? It's like the Mediterranean and Middle East theatre. The Battle of Actium was an important event in the Roman Republic, like how the Mediterranean and Middle East theatre was an important part of World War II. And, like how Marcus Vipsanius Agrippa was a commander in the Battle of Actium, Benito Mussolini was a commander in the Mediterranean and Middle East theatre.";
